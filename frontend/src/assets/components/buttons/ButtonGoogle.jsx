...
export default function ButtonGoogle(props) {
  return (
    <div>
      <button className="w-[280px] sm:w-[430px] md:w-[518px] h-[34px] md:h-[42px] text-[#4A505C] font-bold font-sans rounded-[#F1F1F1] rounded-xl bg-[white] border border-[#F1F1F1] flex justify-center items-center gap-2 p-2.5">
        <svg
          width="20"
          height="20"
          viewBox="0 0 21 21"
