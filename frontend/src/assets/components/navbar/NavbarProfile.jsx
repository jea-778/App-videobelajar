...
export default function NavbarProfile({ imageName }) {
  ...
  const isKategoriActive = location.pathname === "/kategori";
  ...
  return (
    <>
      <div className="flex relative justify-between items-center pt-4 md:pl-[168px] sm:pl-[54px] pl-[27px] pb-4 border shadow-xl md:shadow-none bg-white gap-5">
        <svg
          className="cursor-pointer w-[144px] h-[31px] sm:w-[168px] md:w-[193px] min-w-[144px] min-h-[31px] sm:min-w-[168px] md:min-w-[193px]"
          viewBox="0 0 193 31"
            ...
            <>
              ...
              <div className="flex relative justify-center items-center gap-9 pr-[45px] md:pr-[142px] xl:pr-[162px] md:flex hidden">
                <a
                  ...
                  className={`font-semibold font-sans  cursor-pointer ${isKategoriActive ? "text-[#3ECF4C]" : "text-[#333333AD]"
                    }`}
                >
                  Kategori
                </a>
            ...
            <>
              ...
              <div className="flex flex-row-reverse lg:flex-row relative justify-center items-center gap-4 pr-[45px] md:pr-[142px] xl:pr-[162px] md:flex hidden">
                ...
                <button
                  ...
                  className="font-semibold font-sans  md:w-[94px] md:h-[42px] text-[#FFFFFF] bg-[#3ECF4C] rounded-lg p-2 cursor-pointer"
                >
                  Login
                </button>
                <button
                  onClick={navigateRegister}
                  className="font-semibold font-sans md:w-[94px] md:h-[42px] text-[#3ECF4C] bg-[#ffffff] rounded-lg p-2 border border-[#3ECF4C] cursor-pointer"
                >
                  Register
                </button>
              </div>
                ...
                >
                  <ul>
                    <li className="md:hidden block border md:rounded-t-lg">
                      <a
                        onClick={navigateKategori}
                        className={`md:hidden pt-4 pb-4 pl-3 pr-3 block text-[#333333AD] ${isKategoriActive ? "text-[#3ECF4C]" : "text-[#333333AD]"
                          } hover:bg-gray-100`}
                      >
                        Kategori
                      </a>
                    ...
                    <li className="border md:rounded-t-lg">
                      <a
                        ...
                        className="block md:px-4 md:py-2 pt-4 pb-4 pl-3 pr-3 text-[#333333AD] hover:bg-gray-100"
                      >
                        Profil Saya
                      </a>
                    </li>
                    ...
                    <li className="border md:rounded-b-lg">
                      ...
                      >
                        Keluar
                        <svg
                          className="relative left-2 top-1 w-[20px] h-[18px] cursor-pointer"
                          viewBox="0 0 20 18"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                          <path
                ...
                >
                  <ul>
                    ...
                    <li className="flex flex-col gap-2 border md:rounded-t-lg p-3">
                      <button
                        onClick={navigateLogin}
                        className="font-semibold font-sans md:hidden text-[#FFFFFF] bg-[#3ECF4C] rounded-lg p-2 cursor-pointer"
                      >
                        Login
                      </button>
                      <button
                        onClick={navigateRegister}
                        className="font-semibold font-sans md:hidden text-[#3ECF4C] bg-[#ffffff] rounded-lg p-2 border border-[#3ECF4C] cursor-pointer"
                      >
                        Register
                      </button>
                    </li>
