    ...
    <div className='sm:flex sm:flex-col justify-start text-left pl-3 md:pl-0'>
      <div className="flex flex-col pt-0 sm:pt-4">
        <div className="flex flex-col gap-0 sm:gap-2">
          <h6 className="font-poppins text-[16px] sm:text-[18px] font-[600] leading-[120%] tracking-[0%] text-[#222325]">{title}</h6>
      ...
      <div className="flex pt-2 sm:pt-4">
        ...
        <div className="flex flex-col pl-3">
          <p className='xl:text-[16px] text-[14px] font-sans font-[500] leading-[140%] tracking-[0.2px] text-[#222325]'>{name}</p>
          <p className="xl:flex xl:items-center xl:text-[14px] text-[12px] font-sans font-[400] leading-[140%] tracking-[0.2px] text-[#333333AD]">
            {job} 
            <p className='hidden xl:inline ml-1'>
              {at}
            </p> <strong className='hidden xl:inline ml-1'>{company}</strong>
          </p>
        </div>
      </div>
    </div>
