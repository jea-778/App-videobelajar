...
export default function InputNumber({ type, id, label, select, value, onChange, onKeyDown, error }) {
  return (
          <>
            <div className="pb-4">
              <label className='text-[14px] md:text-[16px] leading-[19.6px] md:leading-[22.4px] tracking-[0.2px] md:tracking-[0.2px] text-[#4A505C] font-sans pb-1'>{label} <span className="text-red-500">*</span></label>
              <div className='flex'>
                ...
                {error && <div className="text-red-500 text-sm sm:text-[16px] mt-2">{error}</div>}
            </div>
          </>
  )
}
