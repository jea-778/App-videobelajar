...
export default function InputPass({ name, id, value, onChange, onKeyDown, error, labelPass, showPass, showConfirmPass, togglePassVisibility }) {
    ...
    <div className='relative'>
      <div className='flex justify-center align-center flex-col pb-4'>
        ...
        <div className='relative'>
          <input
            name={name}
            type={showPass ? 'text' : 'password' && showConfirmPass ? 'text' : 'password'}
            id={id} 
            value={value} 
            onChange={onChange}
            onKeyDown={onKeyDown} 
            ...
            />
          <Eye showPass={showPass || showConfirmPass} onClick={togglePassVisibility} />
        </div>
