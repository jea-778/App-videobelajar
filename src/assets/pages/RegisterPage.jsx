...
export default function RegisterForm() {
    ...
    const newUser = { id: users.length + 1, name, email, gender, number, password, confirmPass, role: 'user' };
...
<>
  ...
  <Navbar />
    ...
    <Container>
      ...
      <div className='bg-white border w-[320px] sm:w-[480px] md:w-[590px] my-[28px] md:my-[64px] mx-auto p-5 md:p-9 gap-9'>
