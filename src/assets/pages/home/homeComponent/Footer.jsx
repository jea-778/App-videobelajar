...
export default function Footer() {
  return (
    <>
      <footer>
        <div className="flex flex-col bg-white border p-5 xl:pb-[60px] xl:pt-[60px] xl:pr-[160px] xl:pl-[160px]">
          <div className="inline xl:flex justify-between">
            <div className="flex flex-col w-[352px]">
              <svg
                className="cursor-pointer xl:h-[31px] h-[25.18px] w-[161.61px] xl:w-[193px]"
                viewBox="0 0 193 31"
              ...
              <div className="flex flex-col w-[300px] xl:w-[352px] gap-2 xl:gap-3 pt-[16px] xl:pt-[28.92px] xl:pb-0 pb-4">
                <p className="text-[#222325] text-[14px] xl:text-[18px] font-sans font-bold leading-[140%] traking-[0.2px]">
                  Gali Potensi Anda Melalui Pembelajaran Video di hariesok.id!
                </p>
                <p className="text-[#222325] text-[14px] xl:text-[16px] font-sans font-[400] leading-[140%] tracking-[0.2px]">
            ...
            <div className="flex flex-col md:flex md:flex-row gap-4 md:gap-12">
              <div className="flex flex-col gap-[15px]">
                <p className="font-sans font-[700] leading-[22.4px] tracking-[0.2px] font-semibold">
                  Kategori
                  <div className="relative">
                    <span className="absolute inline md:hidden right-2 top-[-20px] text-[#3A35418A] cursor-pointer">
                      &#x276F;
                    </span>
                  </div>
                </p>
                <div className="hidden md:flex md:flex-col gap-[15px]">
                  <a
                    href="/about"
                    className="text-[#333333AD] font-sans leading-[140%] tracking-[0.2px]"
                  >
                    Digital & Teknologi
                  </a>
                  <a
              ...
              <div className="flex flex-col gap-[15px]">
                <p className="font-sans font-[700] leading-[140%] tracking-[0.2px] font-semibold">
                  Perusahaan
                  <div className="relative">
                    {/* Icon */}
                    <span className="absolute inline md:hidden right-2 top-[-20px] text-[#3A35418A] cursor-pointer">
          ...
          <div className="pb-5 pt-4 md:pt-[50px]">
            <hr className="w-5/5 mx-auto border border-[#3A35411F]" />
          </div>

          <div className="flex flex-col-reverse xl:flex xl:flex-row justify-between gap-3">
            <p className="text-[#333333AD] font-poppins font-[400] leading-[140%] tracking-[0.2px]">
              @2023 Gerobak Sayur All Right Reserved.
            </p>
            <div className="flex gap-[15px]">
              {/* svg icon */}
              <a href="https://www.linkedin.com/home?originalSubdomain=id">
                <svg
                ...
                >
                  ...
                  />
                  <path
                    d="M22.333 14.6665C23.6591 14.6665 24.9309 15.1933 25.8685 16.131C26.8062 17.0687 27.333 18.3404 27.333 19.6665V25.4998H23.9997V19.6665C23.9997 19.2245 23.8241 18.8006 23.5115 18.488C23.199 18.1754 22.775 17.9998 22.333 17.9998C21.891 17.9998 21.4671 18.1754 21.1545 18.488C20.8419 18.8006 20.6663 19.2245 20.6663 19.6665V25.4998H17.333V19.6665C17.333 18.3404 17.8598 17.0687 18.7975 16.131C19.7352 15.1933 21.0069 14.6665 22.333 14.6665Z"
                    fill="#222325"
                  />
                  <path
                    d="M14.0003 15.5H10.667V25.5H14.0003V15.5Z"
                    fill="#222325"
                  />
                  <path
                    d="M12.3337 12.9998C13.2541 12.9998 14.0003 12.2536 14.0003 11.3332C14.0003 10.4127 13.2541 9.6665 12.3337 9.6665C11.4132 9.6665 10.667 10.4127 10.667 11.3332C10.667 12.2536 11.4132 12.9998 12.3337 12.9998Z"
                    fill="#222325"
                  />
                </svg>
              </a>
              ...
              <a href="https://facebook.com">
                ...
                >
                  ...
                  />
                  <path
                    d="M23.9997 9.6665H21.4997C20.3946 9.6665 19.3348 10.1055 18.5534 10.8869C17.772 11.6683 17.333 12.7281 17.333 13.8332V16.3332H14.833V19.6665H17.333V26.3332H20.6663V19.6665H23.1663L23.9997 16.3332H20.6663V13.8332C20.6663 13.6122 20.7541 13.4002 20.9104 13.2439C21.0667 13.0876 21.2787 12.9998 21.4997 12.9998H23.9997V9.6665Z"
                    fill="#222325"
                  />
                </svg>
              </a>
              ...
              <a href="https://instagram.com">
                ...
                >
                  <path
                    ...
                    stroke-width="1.5"
                  />
                  <g clip-path="url(#clip0_9620_7291)">
                    <path
                      d="M23.167 10.6665H14.8337C12.5325 10.6665 10.667 12.532 10.667 14.8332V23.1665C10.667 25.4677 12.5325 27.3332 14.8337 27.3332H23.167C25.4682 27.3332 27.3337 25.4677 27.3337 23.1665V14.8332C27.3337 12.532 25.4682 10.6665 23.167 10.6665Z"
                      stroke="#222325"
                      stroke-width="2"
              ...
              <a href="https://twitter.com">
                ...
                >
                  <path
                    ...
                    stroke-width="1.5"
                  />
                  <g clip-path="url(#clip0_9620_7297)">
                    <path
